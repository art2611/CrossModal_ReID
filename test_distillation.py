...
writer = SummaryWriter(f"runs/distillation_no_init_test_strict")
pool_dim = 2048
# Init variables :
img_w = 144
img_h = 288
...
suffix_visible = f'regdb_person_VtoV_only_({num_of_same_id_in_batch})_same_id({batch_num_identities})_lr_{lr}'
